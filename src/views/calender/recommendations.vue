    ...
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-xl shadow-lg">
      ...
      <transition name="fade">
        <div v-if="showInput" class="mt-5 bg-gray-100 p-4 rounded-lg shadow-md">
          ...
          <button
            @click="addLabel"
            class="w-full create hover:bg-green-700 text-white font-semibold py-3 px-5 mt-3 rounded-lg transition-all duration-300"
          >
            حفظ
          </button>
        </div>
      ...
      <Button
        ...
        label="حفظ"
        class="w-full create mt-6 text-white font-semibold py-3 px-5 rounded-lg transition-all duration-300 flex items-center justify-center gap-2"
      >
      </Button>
    </div>
