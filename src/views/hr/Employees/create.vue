          ...
          <div class="col-span-2">
            <div>
              <img
                ...
                :class="{ 'p-invalid': submitted && !employee.image }"
                v-if="employee.image"
                :src="employee.image"
              />
              <img
        ...
        <div class="p-[2%] bg-[#FDFDFD] grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div class="flex flex-column gap-2">
            ...
            <Dropdown
              ...
              class="w-full"
              :class="{ 'p-invalid': submitted && !employee.position_id }"
            />
          </div>
          <div class="flex flex-column gap-2">
            <div class="flex">
          ...
          <div
            v-if="employee.type == 0 || employee.type == 2"
          ...
          >
            ...
            <MultiSelect
              ...
              :class="{ 'p-invalid': submitted && !employee.evaluation }"
            />
          </div>
          <div
            v-if="employee.type == 0 || employee.type == 2"
