    ...
    <div class="col-12">
      ...
      <div>
        ...
        >
          <template #header>
            <div class="flex w-full  justify-between align-items-center">
              <Button v-can="'barrier question create'" :label='$t("create_button")' icon="pi pi-plus" class="mr-2" @click="openNew"></Button>

              <h5 class="page-title">{{ $t("questions") }}</h5>
             <div>
        ...
        <Dialog v-model:visible="createdialog" :style="{ width: '450px' }" :header='$t("submit")' :modal="true">
            ...
            <div class="flex flex-column gap-2">
                  <label class="w-full text-start" for="username">{{ $t('Subtest_id') }}</label>
                  <Select required v-model="levels.subtest_id"  option-value="id" filter :options="all_levels" optionLabel="title" :placeholder='$t("Subtest_id")' class="w-full" />
