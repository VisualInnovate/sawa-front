        ...
        <v-list density="compact" nav>
          ...
          >
            ...
            <v-list-item
              ...
              :title="$t('student_programe')"
              value="student-programe"
              :to="{ name: 'student-programe' }"
            ></v-list-item>
            <v-list-item
              v-can="'sessions list'"
              :title="$t('sessions')"
          ...
          >
            ...
            <v-list-item
              v-can="'working hours list'"
              :title="$t('Working_hours')"
              value="Working hours"
              :to="{ name: 'working-hours' }"
            ></v-list-item>
          </v-list-group>
          <v-list-group
          ...
          >
            ...
            <v-list-item
              ...
              :title="$t('student_tans')"
              value="student-transportation"
              :to="{ name: 'student-transportation' }"
            ></v-list-item>

            <v-list-item
              v-can="'transportation schedule list'"
              :title="$t('transportation_schedule')"
              value="transportation-schedule"
              :to="{ name: 'transportation-schedule' }"
            ></v-list-item>

            <v-list-item
              v-can="'treatment list'"
              value="Settings"
              :to="{ name: 'treatments-type' }"
              class=""
            >
