...
`;Y(G);O.render=X;const Q={components:{ConfirmPopup:O},data(){return{search:"",headers:[],children:[],alert_text:null,loading:!0}},computed:{header(){return this.headers=[{key:"id",title:this.$t("index")},{key:"name",title:this.$t("child_name")},{key:"birth_date",title:this.$t("birth_date")},{key:"actions",title:this.$t("actions")}]}},methods:{getChildren(){z.get("/api/child").then(e=>{this.children=e.data.children,console.log(e.data.children),this.loading=!1})},fomate(e){return T(e).format("DD-MM-yy ")},editItem(e){this.$router.push({name:"EditChildren",params:{id:e}})},deleteItem(e){console.log(e),z.delete(`/api/child/${e}/delete`).then(i=>{i.data.status==200&&(this.alert_text="children deleted successfully ",this.children=i.data.children)})},showItem(e){this.$router.push({name:"ShowChildren",params:{id:e}})},create(){this.$router.push({name:"CreateChildren"})}},async mounted(){this.$route.params.alert&&(this.alert_text="done "),this.getChildren()}};function W(e,i,d,u,n,t){const g=E("v-data-table");return a(),C("div",null,[n.alert_text!=null?(a(),v(D,{key:0,type:"success",variant:"tonal",border:"start",elevation:"2",closable:"","close-label":e.$t("close"),text:n.alert_text,class:"mb-8"},null,8,["close-label","text"])):L("",!0),s(N,{text:"Create",color:"green",height:"45",class:"mb-5 mt-5",onClick:t.create},{default:o(()=>[b(m(e.$t("create_button")),1)]),_:1},8,["onClick"]),s($,null,{default:o(()=>[s(U,null,{default:o(()=>[b(m(e.$t("children"))+" ",1),s(q),s(M,{modelValue:n.search,"onUpdate:modelValue":i[0]||(i[0]=r=>n.search=r),"append-icon":"mdi-magnify",label:"Search","single-line":"","hide-details":""},null,8,["modelValue"])]),_:1}),s(g,{headers:t.header,items:n.children,search:n.search},{top:o(()=>[n.loading?(a(),v(Z,{key:0,slot:"progress",style:{color:"#135c65"},indeterminate:""})):L("",!0)]),item:o(({item:r})=>[c("tr",null,[c("td",null,m(r.columns.id),1),c("td",null,m(r.columns.name),1),c("td",null,m(t.fomate(r.columns.birth_date)),1),c("td",null,[s(j,{small:"",color:"primary",class:"mr-2",onClick:y=>t.showItem(r.columns.id)},{default:o(()=>[b("mdi-eye")]),_:2},1032,["onClick"]),s(j,{small:"",color:"primary",class:"mr-2",onClick:y=>t.editItem(r.columns.id)},{default:o(()=>[b("mdi-pencil")]),_:2},1032,["onClick"]),s(j,{small:"",color:"error",onClick:y=>t.deleteItem(r.columns.id)},{default:o(()=>[b("mdi-delete")]),_:2},1032,["onClick"])])])]),_:1},8,["headers","items","search"])]),_:1})])}const te=P(Q,[["render",W]]);export{te as default};
